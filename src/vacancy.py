...
class Vacancy:
    ...
    def __init__(self, title: str, url: str, salary_from: Optional[int],
                 salary_to: Optional[int], description: str):
        self._validate_data(title, url, salary_from, salary_to, description)

        self._title = title
        self._url = url
        self._salary_from = salary_from if salary_from else 0
        self._salary_to = salary_to if salary_to else 0
        self._description = description

    def _validate_data(self, title: str, url: str, salary_from: Optional[int],
                       salary_to: Optional[int], description: str) -> None:
